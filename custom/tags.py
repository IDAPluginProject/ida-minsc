...
class apply(object):
    ...
    @document.parameters(Globals_Contents_Frames='a tuple composed of the global tags, contents tags, and frame members that were read', tagmap='a dictionary used to translate the original tag names with before applying them to the database')
    ...
    @classmethod
    @document.parameters(Globals_Contents_Frames='a tuple composed of the global tags, contents tags, and frame members that are to be applied', tagmap='a dictionary used to translate the original tag names with before applying them to the database')
